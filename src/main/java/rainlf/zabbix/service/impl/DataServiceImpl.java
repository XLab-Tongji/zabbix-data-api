...
public class DataServiceImpl implements DataService {
    ...
    @Override
    public List<Map<String, String>> getHostDataSet(String hostId, Integer timeFrom, Integer timeTill) {
        ...
        for (ItemDO itemDO : itemDOList) {
            // 获取监控项历史数据
            List<ItemDataDO> itemDataDOList = zabbixService.getItemHistoryData(itemDO.getItemId(), Integer.parseInt(itemDO.getValueType()),  null, null);
...
//        int timeTill = 20000;
        ...
        for (int timestamp=timeFrom; timestamp<=timeTill; timestamp+=5) {
            int timestamp2 = timestamp + 5;
